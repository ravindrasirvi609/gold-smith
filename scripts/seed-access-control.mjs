...
const permissions = [
  ...
  },
  {
    ...
    description: "Can create approvals",
  },
  {
    module: "Approval",
    action: "Edit",
    code: "APPROVAL_EDIT",
    description: "Can edit approvals",
  },
  {
    module: "Approval",
    action: "Delete",
    code: "APPROVAL_DELETE",
    description: "Can delete approvals",
  },
  {
    module: "Invoice",
    action: "View",
...
const rolePermissionCodes = {
  ...
  Manager: ["DASHBOARD_VIEW", "USER_VIEW", "PERMISSION_VIEW", "VENDOR_VIEW", "CUSTOMER_VIEW", "KARIGAR_VIEW", "PURCHASE_VIEW", "ISSUE_VIEW", "RECEIPT_VIEW", "PRODUCT_VIEW", "HISTORY_VIEW", "APPROVAL_VIEW", "INVOICE_VIEW", "PAYMENT_VIEW", "AUDIT_VIEW"],
  "Inventory Executive": ["DASHBOARD_VIEW", "USER_VIEW", "PERMISSION_VIEW", "VENDOR_VIEW", "KARIGAR_VIEW", "PURCHASE_VIEW", "PURCHASE_CREATE", "PURCHASE_EDIT", "ISSUE_VIEW", "ISSUE_CREATE", "ISSUE_EDIT", "RECEIPT_VIEW", "RECEIPT_CREATE", "RECEIPT_EDIT", "PRODUCT_VIEW", "HISTORY_VIEW", "APPROVAL_VIEW", "APPROVAL_CREATE", "APPROVAL_EDIT", "INVOICE_VIEW", "PAYMENT_VIEW"],
  "Sales Executive": ["DASHBOARD_VIEW", "USER_VIEW", "PERMISSION_VIEW", "CUSTOMER_VIEW", "APPROVAL_VIEW", "APPROVAL_CREATE", "INVOICE_VIEW", "INVOICE_CREATE", "PAYMENT_VIEW", "PAYMENT_CREATE"],
};
